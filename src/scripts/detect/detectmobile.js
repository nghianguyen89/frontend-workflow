...
var MobileEsp = {
    ...
    DetectWindowsPhone10: function () {
        if (this.uagent.search(this.deviceWinPhone10) > -1) return true;
        else return false;
    },
    ...
    DetectWindowsMobile: function () {
        ...
        if (
            this.uagent.search(this.deviceWinMob) > -1 ||
        ...
        if (
            this.uagent.search(this.devicePpc) > -1 &&
            !(this.uagent.search(this.deviceMacPpc) > -1)
        )
            return true;
        //Test for Windwos Mobile-based HTC devices.
        if (
            this.uagent.search(this.manuHtc) > -1 &&
    ...
    DetectBlackBerry: function () {
        if (
            this.uagent.search(this.deviceBB) > -1 ||
    ...
    DetectBlackBerry10Phone: function () {
        if (
            this.uagent.search(this.deviceBB10) > -1 &&
    ...
    DetectPalmOS: function () {
        ...
        if (
            this.uagent.search(this.devicePalm) > -1 ||
    ...
    DetectWebOSTablet: function () {
        if (
            this.uagent.search(this.deviceWebOShp) > -1 &&
    ...
    DetectWebOSTV: function () {
        if (
            this.uagent.search(this.deviceWebOStv) > -1 &&
    ...
    DetectOperaMobile: function () {
        if (
            this.uagent.search(this.engineOpera) > -1 &&
    ...
    DetectTizen: function () {
        if (
            this.uagent.search(this.deviceTizen) > -1 &&
            this.uagent.search(this.mobile) > -1
        )
            return true;
        else return false;
    ...
    DetectMeegoPhone: function () {
        if (
            this.uagent.search(this.deviceMeego) > -1 &&
            this.uagent.search(this.mobi) > -1
        )
            return true;
        else return false;
    ...
    DetectFirefoxOSPhone: function () {
        ...
        if (
            this.uagent.search(this.engineFirefox) > -1 &&
            this.uagent.search(this.mobile) > -1
        )
            return true;
    ...
    DetectSailfish: function () {
        if (this.uagent.search(this.deviceSailfish) > -1) return true;
        else return false;
    },
    ...
    DetectUbuntu: function () {
        if (this.DetectUbuntuPhone() || this.DetectUbuntuTablet()) return true;
        else return false;
    },
    ...
    DetectUbuntuPhone: function () {
        if (
            this.uagent.search(this.deviceUbuntu) > -1 &&
            this.uagent.search(this.mobile) > -1
        )
            return true;
    ...
    DetectDangerHiptop: function () {
        if (
            this.uagent.search(this.deviceDanger) > -1 ||
    ...
    DetectSonyMylo: function () {
        if (
            this.uagent.search(this.manuSony) > -1 &&
    ...
    DetectMaemoTablet: function () {
        ...
        if (
            this.uagent.search(this.linux) > -1 &&
            this.uagent.search(this.deviceTablet) > -1 &&
    ...
    DetectGamingHandheld: function () {
        if (
            this.uagent.search(this.devicePlaystation) > -1 &&
    ...
    DetectNintendo: function () {
        if (
            this.uagent.search(this.deviceNintendo) > -1 ||
    ...
    DetectMobileQuick: function () {
        ...
        if (
            this.uagent.search(this.engineObigo) > -1 ||
    ...
    DetectMobileLong: function () {
        ...
        if (
            this.uagent.search(this.devicePda) > -1 &&
        ...
        if (
            this.uagent.search(this.manuSamsung1) > -1 ||
